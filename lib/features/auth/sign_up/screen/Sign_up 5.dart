              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        "Take a clear photo of the back of your National ID",
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: const [
                          Icon(Icons.circle_outlined, color: AppColors.blueLight, size: 10),
                          SizedBox(width: 6),
                          Icon(Icons.circle,

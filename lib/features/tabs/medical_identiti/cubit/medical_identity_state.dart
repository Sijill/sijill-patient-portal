...
class DeleteEmergencyContactLoading extends MedicalIdentityState {}

class DeleteEmergencyContactSuccess extends MedicalIdentityState {
  DeleteEmergencyContactResponse deleteEmergencyContactResponse;
  DeleteEmergencyContactSuccess({required this.deleteEmergencyContactResponse});
}

class DeleteEmergencyContactError extends MedicalIdentityState {
  String? message;
  DeleteEmergencyContactError({this.message});
}

...
import 'package:sijil_patient_portal/features/tabs/home_tab/presentation/widget/customed_overview_item.dart';
import 'package:sijil_patient_portal/features/tabs/home_tab/presentation/widget/customed_time_line.dart';
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text("Overview", style: AppStyle.mediumDarkBlue16),
          ),
          ...
          Padding(
            ...
            child: Text("Today's Schedule", style: AppStyle.mediumDarkBlue16),
          ),
          SizedBox(height: height * 0.02),
          CustomedTimeLine(),
        ],

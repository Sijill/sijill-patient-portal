...
class GrantAccessPermissionTokenLaboratoryScreen extends StatelessWidget {
  const GrantAccessPermissionTokenLaboratoryScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final token =
        ModalRoute.of(context)!.settings.arguments
            as GenerateLabPermissionTokenResponse;
    return PopScope(

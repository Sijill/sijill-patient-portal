...
class _GrantConsentScreenState extends State<GrantConsentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: AutoSizeText("Grant Consent", style: AppStyle.semiBoldBlack20),
      ),
      body: SafeArea(
                        ...
                        child: Column(
                          children: [
                            ...
                            CustomedGrantDropDown(
                              ...
                              containerColor: AppColors.containerLightBlueColor,
                            ),
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: CustomedButton(
                          ...
                          onPressed: () {
                            Navigator.of(
                              context,
                            ).pushNamed(AppRoutes.grantConsentAccessCodeScreen);
                          },
                        ),
                      ),
                    ],
